...
export function Card({ ticketsApiUrl = "/api/tickets", className }) {
    ...
    return (_jsx("div", { className: `min-h-screen bg-[#cfe0f7] p-4 ${className ?? ""}`, children: _jsx("div", { className: "w-full p-4", children: _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsxs("div", { className: "rounded border bg-white w-600", style: {
                            width: "700px",
                            textAlign: "left",
                            height: "550px",
                            color: "black",
