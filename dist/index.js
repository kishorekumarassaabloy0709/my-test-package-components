...
const Button = React__default.default.forwardRef(({ variant = 'primary', size = 'md', className, children, ...props }, ref) => {
    return (jsxRuntime.jsx("button", { ref: ref, className: `${styles.button} ${styles[variant]} ${styles[size]} ${className || ''}`, ...props, children: children }));
});
...
function Card({ ticketsApiUrl = "/api/tickets", className }) {
    ...
    return (jsxRuntime.jsx("div", { className: `min-h-screen bg-[#cfe0f7] p-4 ${className ?? ""}`, children: jsxRuntime.jsx("div", { className: "w-full p-4", children: jsxRuntime.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [jsxRuntime.jsxs("div", { className: "rounded border bg-white w-600", style: {
                            width: "700px",
                            textAlign: "left",
                            height: "550px",
                            color: "black",
