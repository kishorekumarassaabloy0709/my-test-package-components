...
const Button = React.forwardRef(({ variant = 'primary', size = 'md', className, ...props }, ref) => {
    return (jsx("button", { ref: ref, className: `${styles$1.button} ${styles$1[variant]} ${styles$1[size]} ${className || ''}`, ...props }));
});
Button.displayName = 'Button';

var styles = {"card":"Card-module_card__56mNv"};

const Card = React.forwardRef(({ className, ...props }, ref) => (jsx("div", { ref: ref, className: `${styles.card} ${className || ''}`, ...props })));
